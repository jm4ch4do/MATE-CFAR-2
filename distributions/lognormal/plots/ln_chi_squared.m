function [ p ] = ln_chi_squared( amount,u,s,limit,step, p_size )
% LN_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Log-Normal
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = ln_chi_squared( 1000,1,0.5,10,0.1,100);
% -----------------------------(example)------------------------------
