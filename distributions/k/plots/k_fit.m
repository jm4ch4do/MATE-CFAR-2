function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,c,v] = k_fit( samples )
% K_GEN_COMPARE Compares a histogram from samples with the ideal PDF K
% -------------------------------------------------------------------------------------------------
...
%           b : estimations of the scale parameter K                                      (1 value)
%           v : estimations of the shape parameter K                                      (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = k_gen( 3000, 1, 3 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,c,v] = k_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
