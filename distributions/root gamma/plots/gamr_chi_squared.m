function [ p ] = gamr_chi_squared( amount,b,v,limit,step, p_size )
% GAMR_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Root-Gamma  
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = gamr_chi_squared( 1000,1,3,15,0.1,100);
% -----------------------------(example)------------------------------
