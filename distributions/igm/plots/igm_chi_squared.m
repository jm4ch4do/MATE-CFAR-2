function [ p ] = igm_chi_squared( amount,b, a,limit,step, p_size )
% IGM_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test InvGam
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = igm_chi_squared( 1000,5,5,5,0.1,100);
% -----------------------------(example)------------------------------
