function [ p ] = ww_chi_squared( amount,mix, a1, b1, a2, b2,limit,step, p_size )
% WW_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test WW
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = ww_chi_squared( 1000,0.5,1,2,3,3,15,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    ideal= ww_pdf(x1, mix, a1, b1, a2, b2);
    
    % expected values for the ideal (theoretical) Weibull Weibull distribution
