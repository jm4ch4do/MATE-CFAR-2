function [ y, obs , xout, prob_obs, ideal ] = lom_gen_compare( amount, b, a, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = lom_gen_compare( 1000, 5, 5, 10, 0.1 );
% ---------------------------------(example)-------------------------------------------
