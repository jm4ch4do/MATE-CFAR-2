function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,b,v] = gamr_fit( samples )
...
%           b : estimation of the scale parameter Root-Gamma                              (1 value)
%           v : estimation of the shape parameter Root-Gamma                              (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = gamr_gen( 3000, 1, 3 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,b,v] = gamr_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
...
% --- estimate parameters
[ b,v ] = gamr_estim_par( samples,100 );
...
ideal= gamr_pdf(x, b, v);

% expected values for the ideal (theoretical) Root-Gamma distribution
esp = ideal*m*step;
