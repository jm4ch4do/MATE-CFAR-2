function [  ] = kk_pdf_plot3( )
%KK_PDF_PLOT plots examples of PDF KK 3.
%---------------------------
%
%INICIATING VALUES-----------------------------------------------------
%  X1:  vector of x data
...
[m,n] = size(x1);
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk_pdf(x1,  0, 2, 0.5, 10, 20);
YMatrix1(2,:)= kk_pdf(x1,0.3, 2, 0.5, 10, 20);
YMatrix1(3,:)= kk_pdf(x1,0.7, 2, 0.5, 10, 20);
YMatrix1(4,:)= kk_pdf(x1,  1, 2, 0.5, 10, 20);
%
%----------------------------------------------------------------------
%CREATING FIGURE-------------------------------------------------------
%
