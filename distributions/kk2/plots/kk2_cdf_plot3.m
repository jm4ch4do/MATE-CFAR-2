function [  ] = kk2_cdf_plot3( )
%KK2_CDF_PLOT 3 plots examples of PDF KK2 3.
%---------------------------
%
%INICIATING VALUES-----------------------------------------------------
%  X1:  vector of x data
...
[m,n] = size(x1);
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk2_cdf(x1,  0, 2, 0.5, 10, 20);
YMatrix1(2,:)= kk2_cdf(x1,0.3, 2, 0.5, 10, 20);
YMatrix1(3,:)= kk2_cdf(x1,0.7, 2, 0.5, 10, 20);
YMatrix1(4,:)= kk2_cdf(x1,  1, 2, 0.5, 10, 20);
%
%----------------------------------------------------------------------
%CREATING FIGURE-------------------------------------------------------
%
