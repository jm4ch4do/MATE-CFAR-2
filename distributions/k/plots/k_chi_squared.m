function [ p ] = k_chi_squared( amount,c,v,limit,step, p_size )
% K_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test K  
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = k_chi_squared( 1000,1,3,10,0.1,100);
% -----------------------------(example)------------------------------
