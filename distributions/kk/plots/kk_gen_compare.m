function [ y, obs , xout, prob_obs, ideal ] = kk_gen_compare( amount, mix, c1, v1, c2, v2, limit, step )
% KK_GEN_COMPARE Compares a histogram from samples with the ideal PDF K-K
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = kk_gen_compare( 1000, 0.5, 2, 0.5, 10, 20, 2, 0.1 );
% -------------------------------------(example)---------------------------------------
...
%---
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk_pdf(x1,mix,c1,v1,c2,v2);
ideal = YMatrix1;
%
%CREATING FIGURE-------------------------------------------------------
%
