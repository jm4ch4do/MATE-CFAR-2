function [ y, obs , xout, prob_obs, ideal ] = ray_gen_compare_cdf( amount, a, limit, step )
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = ray_gen_compare_cdf( 1000, 1, 5, 0.1 );
% -------------------------------------(example)---------------------------------------
