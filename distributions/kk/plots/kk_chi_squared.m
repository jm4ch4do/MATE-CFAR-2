function [ p ] = kk_chi_squared( amount,mix, c1, v1, c2, v2,limit,step, p_size )
% KK_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test KK
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = kk_chi_squared( 1000,0.5,1,2,3,3,15,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    ideal= kk_pdf(x1, mix, c1, v1, c2, v2);
