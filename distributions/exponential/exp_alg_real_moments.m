function [ mar_1, mar_2, mar_3, mar_4 ] = exp_alg_real_moments( amount,s,sets )
% EXP_ALG_MOMENTS Computes real (empirical) algebraic moments Exponential
% -----------------------------------------------------------------------
...
% -------   --------------------(example)--------------------------------
% [ mar_1, mar_2, mar_3, mar_4 ] = exp_alg_real_moments( 1000,1,100);
% ------------------------------(example)--------------------------------
