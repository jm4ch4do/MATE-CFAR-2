function [ y, obs , xout, prob_obs, ideal ] = gau_gen_compare( amount, u, s, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = gau_gen_compare( 1000, 1, 2, 6, 0.1 );
% ---------------------------------(example)-------------------------------------------
