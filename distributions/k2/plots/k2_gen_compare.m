function [ y, obs , xout, prob_obs, ideal ] = k2_gen_compare( amount, c, v, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = k2_gen_compare( 1000, 1, 3, 6, 0.1 );
% ---------------------------------(example)-------------------------------------------
