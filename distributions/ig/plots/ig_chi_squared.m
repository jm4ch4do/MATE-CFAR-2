function [ p ] = ig_chi_squared( amount,u, l,limit,step, p_size )
% IG_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test InvGaus
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = ig_chi_squared( 1000,1,1,5,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    % expected values for the ideal (theoretical) InvGaus distribution
