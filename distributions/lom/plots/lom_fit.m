function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,b,a] = lom_fit( samples )
% LOM_GEN_COMPARE Compares a histogram from samples with the ideal PDF Lomax
% -------------------------------------------------------------------------------------------------
...
%           b : estimation of the scale parameter Lomax                                   (1 value)
%           a : estimation of the shape parameter Lomax                                   (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = lom_gen( 3000, 5, 5 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,b,a] = lom_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
...
% expected values for the ideal (theoretical) Lomax distribution
esp = ideal*m*step;
