function [ d ] = cmld_cfar( s,cut,g,T,om )
% CMLD_CFAR Detection with CMLD-CFAR for fixed window
% ----------------------------------------------------------
...
%    om : cells omitted                            (1 value)    
% -----   --------------------------------------------------
%     d : result of detection                      (1 value)
% -----   ---------------(example)--------------------------
% [ d ] = cmld_cfar( [1 10 1 1 1 1 1 10]' ,5,0,4,2 )
% [ d ] = cmld_cfar( [1 10 1 1 1 1 1 10]' ,5,0,4,1 )
% -----------------------(example)--------------------------
