function [  ] = kk2_pdf_plot2( )
%KK2_PDF_PLOT 2 plots examples of PDF KK2 2.
%---------------------------
%
%INICIATING VALUES-----------------------------------------------------
%  X1:  vector of x data
...
[m,n] = size(x1);
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk2_pdf(x1,0.5, 2, 1, 5, 1  );
YMatrix1(2,:)= kk2_pdf(x1,0.5, 2, 1, 5, 2  );
YMatrix1(3,:)= kk2_pdf(x1,0.5, 2, 1, 5, 3.5);
YMatrix1(4,:)= kk2_pdf(x1,0.5, 2, 1, 5, 6  );
%
%----------------------------------------------------------------------
%CREATING FIGURE-------------------------------------------------------
%
