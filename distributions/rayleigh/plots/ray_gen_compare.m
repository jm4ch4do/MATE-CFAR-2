function [ y, obs , xout, prob_obs, ideal ] = ray_gen_compare( amount, a, limit, step )
% RAY_GEN_COMPARE Compares a histogram from samples with the ideal PDF Rayleigh
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Rayleigh                      (row vector)
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = ray_gen_compare( 1000, 1, 5, 0.1 );
% ---------------------------------(example)-------------------------------------------
