function [ y, obs , xout, prob_obs, ideal ] = par_gen_compare_cdf( amount, a, b, limit, step )
% PAR_GEN_COMPARE Compares a histogram from samples with the ideal CDF Pareto
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Pareto                        (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = par_gen_compare_cdf( 1000, 2, 2, 10, 0.1 );
% -------------------------------------(example)---------------------------------------
