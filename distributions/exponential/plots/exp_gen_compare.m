function [ y, obs , xout, prob_obs, ideal ] = exp_gen_compare( amount, s, limit, step )
% EXP_GEN_COMPARE Compares a histogram from samples with the ideal PDF Exponential
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Exponential                   (row vector)
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = exp_gen_compare( 1000, 1, 7, 0.1 );
% ---------------------------------(example)-------------------------------------------
...
%Graficar la curva de las muestras en la misma gráfica
