function [ y, obs , xout, sum_prob_obs, ideal ] = gam_gen_compare_cdf( amount, b, v,limit, step )
% GAM_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF Gamma
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Gamma                         (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = gam_gen_compare_cdf( 1000, 1, 3, 15, 0.1 );
% -------------------------------------(example)---------------------------------------
