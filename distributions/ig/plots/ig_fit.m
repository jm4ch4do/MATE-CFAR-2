function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,u,l] = ig_fit( samples )
% IG_GEN_COMPARE Compares a histogram from samples with the ideal PDF InvGaus
% -------------------------------------------------------------------------------------------------
...
%           u : estimation of the localization parameter InvGaus                          (1 value)
%           l : estimation of the scale parameter InvGaus                                 (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = ig_gen( 3000, 1, 1 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,u,l] = ig_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
...
% expected values for the ideal (theoretical) Inverse-Gaussian distribution
esp = ideal*m*step;
