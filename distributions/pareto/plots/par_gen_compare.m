function [ y, obs , xout, prob_obs, ideal ] = par_gen_compare( amount, a, b, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = par_gen_compare( 1000, 2, 2, 10, 0.1 );
% ---------------------------------(example)-------------------------------------------
