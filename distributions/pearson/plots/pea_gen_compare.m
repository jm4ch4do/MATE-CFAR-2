function [ y, obs , xout, prob_obs, ideal ] = pea_gen_compare( amount, g, limit, step )
...
%     ideal : ideal plot of the distribution Pearson                       (row vector)
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = pea_gen_compare( 1000, 0.2, 5, 0.1 );
% ---------------------------------(example)-------------------------------------------
