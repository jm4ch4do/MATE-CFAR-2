function [ y, obs , xout, prob_obs, ideal ] = ln_gen_compare_cdf( amount, u, s, limit, step )
% LN_GEN_COMPARE Compares a histogram from samples with the ideal CDF Log-Normal
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Log-Normal                    (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = ln_gen_compare_cdf( 1000, 1, 0.5, 10, 0.1 );
% -------------------------------------(example)---------------------------------------
