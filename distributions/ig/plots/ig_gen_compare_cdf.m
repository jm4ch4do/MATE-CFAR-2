function [ y, obs , xout, sum_prob_obs, ideal ] = ig_gen_compare_cdf( amount, u, l,limit, step )
% IG_GEN_COMPARE Compares a histogram from samples with the ideal CDF InvGauss
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = ig_gen_compare_cdf( 1000, 1, 1, 5, 0.1 );
% -------------------------------------(example)---------------------------------------
