function [ y, obs , xout, sum_prob_obs, ideal ] = k_gen_compare_cdf( amount, c, v,limit, step )
% K_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF K
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution K                             (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = k_gen_compare_cdf( 1000, 1, 3, 6, 0.1 );
% -------------------------------------(example)---------------------------------------
