function [ y, obs , xout, prob_obs, ideal ] = exp_gen_compare_cdf( amount, s, limit, step )
% EXP_GEN_COMPARE Compares a histogram from samples with the ideal CDF Exponential
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = exp_gen_compare_cdf( 1000, 1, 10, 0.1 );
% -------------------------------------(example)---------------------------------------
