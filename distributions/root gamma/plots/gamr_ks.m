function [ p ] = gamr_ks( amount,b, v, p_size )
% GAMR_KS Computes the 'p' values of the K-S statistic test Root-Gamma  
% --------------------------------------------------------------------
