function [ y, obs , xout, prob_obs, ideal ] = ln_gen_compare( amount, u, s, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = ln_gen_compare( 1000, 1, 0.5, 10, 0.1 );
% ---------------------------------(example)-------------------------------------------
