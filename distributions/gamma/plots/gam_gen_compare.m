function [ y, obs , xout, prob_obs, ideal ] = gam_gen_compare( amount, b, v, limit, step )
...
%----------   ---------------------(example)-------------------------------------------
% [y,obs,xout,prob_obs, ideal] = gam_gen_compare( 1000, 1, 3, 15, 0.1 );
% ---------------------------------(example)-------------------------------------------
