function [ y ] = ww_gen_plot( amount, mix, a1, b1, a2, b2)
% WW_GEN_PLOT Plots the generated samples into a time sequence Weibull Weibull
% ------------------------------------------------------------------------
...
% ---------   -------------------(example)--------------------------------
% [ y ] = ww_gen_plot( 3000, 0.5,1, 2,2,2 );
% -------------------------------(example)--------------------------------
