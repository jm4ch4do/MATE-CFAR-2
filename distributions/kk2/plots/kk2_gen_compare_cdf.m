function [ y, obs , xout, sum_prob_obs, ideal ] = kk2_gen_compare_cdf( amount, mix, c1, v1, c2, v2, limit, step )
% KK2_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF K-K2
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = kk2_gen_compare_cdf( 1000, 0.5, 2, 0.5, 10, 20, 2, 0.1 );
% -------------------------------------(example)---------------------------------------
...
%---
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk2_cdf(x1,mix,c1,v1,c2,v2);
ideal = YMatrix1;
%
%CREATING FIGURE-------------------------------------------------------
%
...
%
% Create ylabel
ylabel({'PDF KK2','(mix,c1,v1,c2,v2)'});
%
% Create legend
