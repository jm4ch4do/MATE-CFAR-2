function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,a] = ray_fit( samples )
...
%           a : estimations of the scale parameter Rayleigh                               (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = ray_gen( 3000, 1 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,a] = ray_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
