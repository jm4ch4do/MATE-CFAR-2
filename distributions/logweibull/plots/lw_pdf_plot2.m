function [  ] = lw_pdf_plot2( )
%LW_PDF_PLOT plots examples of PDF Log-Weibull 2.
%---------------------------
%
%INICIATING VALUES-----------------------------------------------------
%  X1:  vector of x data
...
[m,n] = size(x1);
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= lw_pdf(x1,1  ,1);
YMatrix1(2,:)= lw_pdf(x1,2  ,1);
YMatrix1(3,:)= lw_pdf(x1,5  ,1);
YMatrix1(4,:)= lw_pdf(x1,10 ,1);
%
%----------------------------------------------------------------------
%CREATING FIGURE-------------------------------------------------------
%
