function [ p ] = exp_chi_squared( amount,s,limit,step, p_size )
% EXP_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Exponential
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = exp_chi_squared( 1000,1,15,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    % expected values for the ideal (theoretical) Exponential distribution
