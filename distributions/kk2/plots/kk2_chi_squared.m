function [ p ] = kk2_chi_squared( amount,mix, c1, v1, c2, v2,limit,step, p_size )
% KK2_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test KK2
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% [ p ] = kk2_chi_squared( 1000,0.5,1,2,3,3,3,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    ideal= kk2_pdf(x1, mix, c1, v1, c2, v2);
    
    % expected values for the ideal (theoretical) KK distribution
