function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,a,b] = par_fit( samples )
% PAR_GEN_COMPARE Compares a histogram from samples with the ideal PDF Pareto
% -------------------------------------------------------------------------------------------------
...
%           a : estimation of the shape parameter Pareto                                  (1 value)
%           b : estimation of the scale parameter Pareto                                  (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = par_gen( 3000, 2, 2 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,a,b] = par_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
