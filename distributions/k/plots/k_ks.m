function [ p ] = k_ks( amount,b, v, p_size )
% K_KS Computes the 'p' values of the K-S statistic test K
% --------------------------------------------------------------------
%     amount : amount of samples in the set                  (1 value)
%          b : scale parameter K               			     (1 value)
...
for p_1 = 1:p_size
    ...
    test(:,1) = k_gen( amount,b,v);
    test(:,2) = (k_cdf((test(:,1))',b,v))';
