function [ y, obs , xout, sum_prob_obs, ideal ] = gamr_gen_compare_cdf( amount, b, v,limit, step )
% GAMR_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF Root-Gamma
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = gamr_gen_compare_cdf( 1000, 1, 3, 6, 0.1 );
% -------------------------------------(example)---------------------------------------
