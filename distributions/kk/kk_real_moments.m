function [ me,va,skew,kurt] = kk_real_moments( amount,mix,c1,v1,c2,v2,sets )
% KK_REAL_MOMENTS Generates the survival function K-K
% ------------------------------------------------------------------
...
%      ---   -------------------------------------------------------
%       me : first real moment KK                        (row vector)
%       va : second real moment KK                       (row vector)
%     skew : third real moment KK                        (row vector)
%     kurt : fourth real moment KK                       (row vector)
% --------   ----------(example)------------------------------------
% [ me,va,skew,kurt ] = kk_real_moments( 1000,0.5, 2, 0.5, 10, 20,100 );
% ---------------------(example)------------------------------------
