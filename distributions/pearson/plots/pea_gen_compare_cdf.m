function [ y, obs , xout, sum_prob_obs, ideal ] = pea_gen_compare_cdf( amount, g,limit, step )
% RAY_GEN_COMPARE Compares a histogram from samples with the ideal CDF Rayleigh
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = pea_gen_compare_cdf( 1000, 0.2, 5, 0.1 );
% -------------------------------------(example)---------------------------------------
