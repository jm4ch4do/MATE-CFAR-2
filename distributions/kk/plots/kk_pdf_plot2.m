function [  ] = kk_pdf_plot2( )
%KK_PDF_PLOT2 plots examples of PDF KK 2.
%---------------------------
%
%INICIATING VALUES-----------------------------------------------------
%  X1:  vector of x data
...
[m,n] = size(x1);
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk_pdf(x1,0.5, 2, 1, 5, 1  );
YMatrix1(2,:)= kk_pdf(x1,0.5, 2, 1, 5, 2  );
YMatrix1(3,:)= kk_pdf(x1,0.5, 2, 1, 5, 3.5);
YMatrix1(4,:)= kk_pdf(x1,0.5, 2, 1, 5, 6  );
%
%----------------------------------------------------------------------
%CREATING FIGURE-------------------------------------------------------
%
