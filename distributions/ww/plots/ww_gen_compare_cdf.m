function [ y, obs , xout, sum_prob_obs, ideal ] = ww_gen_compare_cdf( amount, mix, a1, b1, a2, b2, limit, step )
% WW_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF Weibull Weibull
% -------------------------------------------------------------------------------------
...
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = ww_gen_compare_cdf( 1000, 0.5, 2, 0.5, 10, 20, 4, 0.1 );
% -------------------------------------(example)---------------------------------------
...
%---
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= ww_cdf(x1,mix,a1,b1,a2,b2);
ideal = YMatrix1;
%
%CREATING FIGURE-------------------------------------------------------
%
...
str4 = num2str(a2);
str5 = num2str(b2);
out = ['mix=' str1 '   a1= ' str2 '   b1= ' str2 '   a2= ' str2 '   b2= ' str2];
