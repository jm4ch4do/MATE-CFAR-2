function [ y, obs , xout, prob_obs, ideal ] = w_gen_compare_cdf( amount, a, b, limit, step )
% W_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF Weibull
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution Weibull                       (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = w_gen_compare_cdf( 1000, 1, 2, 4, 0.1 );
% -------------------------------------(example)---------------------------------------
