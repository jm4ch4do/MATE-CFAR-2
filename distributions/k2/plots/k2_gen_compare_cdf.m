function [ y, obs , xout, sum_prob_obs, ideal ] = k2_gen_compare_cdf( amount, c, v,limit, step )
% K2_GEN_COMPARE_CDF Compares a histogram from samples with the ideal CDF K2
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution K2                            (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = k2_gen_compare_cdf( 1000, 1, 3, 6, 0.1 );
% -------------------------------------(example)---------------------------------------
