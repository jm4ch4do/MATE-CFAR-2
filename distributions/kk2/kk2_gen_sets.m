function [ y ] = kk2_gen_sets( amount,mix, c1, v1, c2, v2)
% KK2_GEN_SETS generates multiple sets K-K2
% -----------------------------------------------------------------------
...
% ---------   ----------------(example)----------------------------------
% [ samples ] =kk2_gen_sets( 1000,[0.5 0.5 0.5],[ 2 2 2 ],[ 0.5 0.5 0.5 ],[ 10 10 10 ],[ 20 20 20 ]);
% ----------------------------(example)----------------------------------
...
for n_1 = 1:n
    ...
    cc2 = c2(1,n_1);
    vv2 = v2(1,n_1);
    y(:,n_1) = kk2_gen(amount,mixx,cc1,vv1,cc2,vv2);
end
