function [ p ] = gam_chi_squared( amount,b,v,limit,step, p_size )
% GAM_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Gamma  
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = gam_chi_squared( 1000,1,3,15,0.1,100);
% -----------------------------(example)------------------------------
