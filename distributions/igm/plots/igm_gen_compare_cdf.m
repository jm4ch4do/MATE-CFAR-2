function [ y, obs , xout, sum_prob_obs, ideal ] = igm_gen_compare_cdf( amount, b, a,limit, step )
% IGM_GEN_COMPARE Compares a histogram from samples with the ideal CDF InvGam
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution InvGam                        (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = igm_gen_compare_cdf( 1000, 5, 5, 5, 0.1 );
% -------------------------------------(example)---------------------------------------
