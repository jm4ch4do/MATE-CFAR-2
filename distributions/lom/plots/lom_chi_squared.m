function [ p ] = lom_chi_squared( amount,b,a,limit,step, p_size )
% LOM_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Lomax
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = lom_chi_squared( 1000,5,5,5,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    % fixing the first value of the 'obs' matrix
    obs(1) = esp(1);
