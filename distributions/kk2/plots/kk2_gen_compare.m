function [ y, obs , xout, prob_obs, ideal ] = kk2_gen_compare( amount, mix, c1, v1, c2, v2, limit, step )
% KK2_GEN_COMPARE Compares a histogram from samples with the ideal PDF K-K2
% -------------------------------------------------------------------------------------
...
%     ideal : ideal plot of the distribution KK2                           (row vector)
% ---------   -------------------------(example)---------------------------------------
% [y,obs,xout,prob_obs, ideal] = kk2_gen_compare( 1000, 0.5, 2, 0.5, 10, 20, 2, 0.1 );
% -------------------------------------(example)---------------------------------------

% calling the generation function KK2
y = kk2_gen( amount,mix, c1, v1, c2, v2);
...
%---
YMatrix1 = zeros(m,n);
YMatrix1(1,:)= kk2_pdf(x1,mix,c1,v1,c2,v2);
ideal = YMatrix1;
%
%CREATING FIGURE-------------------------------------------------------
%
...
%set(plot1(1),'DisplayName','mix= 0.5   c1=   2   v1= 0.5   c2=10   v2=20');
...
str4 = num2str(c2);
str5 = num2str(v1);
out = ['mix=' str1 '   c1= ' str2 '   v1= ' str3 '   c2= ' str4 '   v2= ' str5    ];
...
%
% Create ylabel
ylabel({'PDF K-K2','(mix,c1,v1,c2,v2)'});
%
% Create legend
