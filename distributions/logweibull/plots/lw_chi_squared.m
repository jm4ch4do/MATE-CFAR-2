function [ p ] = lw_chi_squared( amount,a,b,limit,step, p_size )
% LW_CHI_SQUARED Computes the 'p' values of the Chi-2 statistic test Log-Weibull
% --------------------------------------------------------------------
...
% ----------   ----------------(example)------------------------------
% p = lw_chi_squared( 1000,1,2,15,0.1,100);
% -----------------------------(example)------------------------------
...
for p_1 = 1:p_size
    ...
    x1 = 1:step:limit;
    x1(1,1)= 1.00001; % making the first value different from 1
    ideal= lw_pdf(x1, a,b);
