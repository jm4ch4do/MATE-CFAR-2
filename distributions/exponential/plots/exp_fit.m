function [  PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res,p_chi,p_ks,s] = exp_fit( samples )
...
% %         s : estimation of the scale parameter Exponential                             (1 value)
%------------   -------------------------(example)-------------------------------------------------
% [ samples ] = exp_gen( 3000, 1 );
% [ PDF, PDFe, CDFe, CDF, x, PDF_res,CDF_res, p_chi,p_ks,s] = exp_fit( samples );
% ---------------------------------------(example)-------------------------------------------------
